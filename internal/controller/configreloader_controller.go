...
// +kubebuilder:rbac:groups=config.config.dev,resources=configreloaders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=config.config.dev,resources=configreloaders/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=config.config.dev,resources=configreloaders/finalizers,verbs=update
